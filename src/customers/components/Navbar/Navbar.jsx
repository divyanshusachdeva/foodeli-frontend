...
const Navbar = () => {
  ...
  return (
    <div className="px-5 z-50 py-[.8rem] bg-orange-500  lg:px-20 flex justify-between">
      <div className="flex items-center space-x-4">
        ...
        >
          <li className="logo font-semibold text-gray-300 text-2xl">
            <img
              src="FoodeliLogo.png"  // Update with the correct path to your image
              alt="Foodeli"
              className="h-10 w-30" // You can adjust height and width as per your requirements
            />
          </li>
        </div>
